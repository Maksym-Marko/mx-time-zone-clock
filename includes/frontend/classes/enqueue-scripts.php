	...
	*/
	public static function mxmtzc_register()
	{
		...
		public static function mxmtzc_enqueue()
		{
			...
			wp_enqueue_style( 'mxmtzc_style', MXMTZC_PLUGIN_URL . 'includes/frontend/assets/css/style.css', array( 'mxmtzc_font_awesome' ), MXMTZC_PLUGIN_VERSION, 'all' );
			
			wp_enqueue_script( 'mxmtzc_script', MXMTZC_PLUGIN_URL . 'includes/frontend/assets/js/script.js', array( 'jquery' ), MXMTZC_PLUGIN_VERSION, false );
